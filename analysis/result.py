...
import numpy as np
from beartype.typing import Iterator, Mapping, Optional
from jaxtyping import Shaped
from roverd.sensors import SensorData
...
class Result:
    ...
    def get_rendered_data(self, eval: str) -> SensorData:
        """Get rendered data container."""
        return SensorData(os.path.join(
            self.path, "eval", eval.replace(".npz", "")))
